...
//	Render(x,y,CA2W(sBuffer));//CW2A将宽字符集（Unicode）转化为多字符集（ASCII） CA2W就是反过来转换了
	wchar_t wText[1024] = {0};
	MByteToWChar(sBuffer,wText,sizeof(wText)/sizeof(wText[0]));

	Render(x,y,(wchar_t*)(unsigned short *)(wText));
